...
keywords: Azure, javascript, SDK, API, @azure/arm-msi, managedserviceidentity
author: qiaozha
ms.author: qiaozha
ms.date: 01/08/2022
ms.topic: reference
...
---
# Azure ManagedServiceIdentity client library for JavaScript - Version 2.0.1-alpha.20220107.1 
