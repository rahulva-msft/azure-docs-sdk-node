...
keywords: Azure, javascript, SDK, API, @azure/arm-containerinstance, containerinstances
author: qiaozha
ms.author: qiaozha
ms.date: 01/06/2022
ms.topic: reference
...
---
# Azure ContainerInstanceManagement client library for JavaScript - Version 8.0.0-alpha.20220106.1 
