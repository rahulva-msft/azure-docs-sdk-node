...
keywords: Azure, javascript, SDK, API, @azure-rest/purview-administration, purviewadministration
author: maggiepint
ms.author: magpint
ms.date: 11/20/2021
ms.topic: reference
...
ms.service: purviewadministration
---

# Azure Purview Administration REST client library for JavaScript - Version 1.0.0-alpha.20211104.3 
