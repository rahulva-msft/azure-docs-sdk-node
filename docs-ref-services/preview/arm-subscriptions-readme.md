...
keywords: Azure, javascript, SDK, API, @azure/arm-subscriptions, subscriptions
author: qiaozha
ms.author: qiaozha
ms.date: 01/06/2022
ms.topic: reference
...
---
# Azure Subscription client library for JavaScript - Version 4.0.1-alpha.20220105.1 
